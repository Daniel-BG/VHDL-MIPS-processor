...
ENTITY ps2_keyboard IS
  GENERIC(
    clk_freq              : INTEGER := 781250; 		--system clock frequency in Hz (reloj de 100MHz/128)
    debounce_counter_size : INTEGER := 2);         --set such that (2^size)/clk_freq = 5us (size = 8 for 50MHz)
  PORT(
